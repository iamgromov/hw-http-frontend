[![Build status](https://ci.appveyor.com/api/projects/status/cprtqp4dh33qy8di?svg=true)](https://ci.appveyor.com/project/iamgromov/hw-http-frontend)

# [server](https://github.com/iamgromov/hw-http-backend) for this project
...
![](https://github.com/netology-code/ahj-homeworks/raw/AHJ-50/http/pic/helpdesk.png)

Модальное окно добавления нового тикета (вызывается по кнопке "Добавить тикет" в правом верхнем углу):

![](https://github.com/netology-code/ahj-homeworks/raw/AHJ-50/http/pic/helpdesk-2.png)

Модальное окно редактирования существующего тикета (вызвается по кнопке с иконкой "✎" - карандашик):

![](https://github.com/netology-code/ahj-homeworks/raw/AHJ-50/http/pic/helpdesk-3.png)

Модальное окно подтверждения удаления (вызывается по кнопке с иконкой "x" - крестик):

![](https://github.com/netology-code/ahj-homeworks/raw/AHJ-50/http/pic/helpdesk-4.png)

Для просмотра деталей тикета нужно нажать на тело тикета (но не на кнопки - "сделано", "редактировать" или "удалить"):

![](https://github.com/netology-code/ahj-homeworks/raw/AHJ-50/http/pic/helpdesk-5.png)
